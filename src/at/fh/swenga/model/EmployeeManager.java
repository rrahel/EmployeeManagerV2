...
public class EmployeeManager {
    ...
    public EmployeeModel createEmployeeModel(int ssn, String firstName, String lastName, Date dayOfBirth) {
	return new EmployeeModel(ssn, firstName, lastName, dayOfBirth);
    }
